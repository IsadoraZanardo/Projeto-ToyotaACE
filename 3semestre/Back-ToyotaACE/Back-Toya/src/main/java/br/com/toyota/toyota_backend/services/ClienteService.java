...
public class ClienteService {
    ...
    public Cliente atualizarFinanciamento(Long id, FinanciamentoRequest dados) {
        ...
        if (!cliente.getVeiculos().isEmpty()) {
            Veiculo veiculo = cliente.getVeiculos().get(cliente.getVeiculos().size() - 1);
            ...
            if (dados.getStatusFinanciamento() != null)
                veiculo.setStatusFinanciamento(dados.getStatusFinanciamento());

            if (dados.getStatusGarantia() != null)
                veiculo.setStatusGarantia(dados.getStatusGarantia());

            if (dados.getDataProximaRevisao() != null)
                veiculo.setDataProximaRevisao(dados.getDataProximaRevisao());
    ...
    private void preencherDadosVeiculo(Veiculo veiculo, VeiculoRequest dados) {
        ...
        if (veiculo.getChassiVeiculo() == null || veiculo.getChassiVeiculo().isBlank()) {
            String chassi;
        ...
        if (dados.getCombustivelVeiculo() != null)
            veiculo.setCombustivelVeiculo(dados.getCombustivelVeiculo());
